...
public class Game extends ApplicationAdapter {
	...
	public void create () {
		...
		COMMODORE_64_UI = assetManager.get("android/assets/skin/Commodore_64_UI/commodore64ui/uiskin.json");
		SCI_FI_ATLAS = assetManager.get("android/assets/skin/Sci_fi/panels.atlas");
	...
	public void setParams() {
		...
		FONT_CONSOLE_32 = assetManager.get("android/assets/font/console_32.fnt", BitmapFont.class);
		FONT_CONSOLE_48 = assetManager.get("android/assets/font/console_48.fnt", BitmapFont.class);
		FONT_CONSOLE_72 = assetManager.get("android/assets/font/console_72.fnt", BitmapFont.class);
		FONT_CONSOLE_120 = assetManager.get("android/assets/font/console_120.fnt", BitmapFont.class);
		FONT_CONSOLE_155 = assetManager.get("android/assets/font/console_155.fnt", BitmapFont.class);
		...
		NEUTRALIZER_UI = assetManager.get("android/assets/skin/Neutralizer_UI/neutralizerui/neutralizer-ui.json");
		NEON_UI = assetManager.get("android/assets/skin/NeonUI/neonui/neon-ui.json");
		KOMMOC_UI = assetManager.get("android/assets/skin/Kommoc_UI/Kommoc_UI.json");
		
		FX_ATLAS = assetManager.get("android/assets/fx/atlas/tex_fx.atlas");
