...
public class DAGuiInGame_2 extends GuiBase {
	...
	//TableMenuInGame table_menu	= new TableMenuInGame();
	...
	ItemNode slot_1	= new ItemNode(0);
	ItemNode slot_2	= new ItemNode(1);
	ItemNode slot_3	= new ItemNode(2);
	...
	public DAGuiInGame_2(Game game) {
		super(game);
		...
		table_item.addListener(new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				/*if(current_item != null && current_item.getItem() instanceof ItemWeapon) {
					...
					int ammo_max = ((ItemWeapon)current_item.getItem()).getMaxAmmo();
		...
		clickListener = new ClickListener() {
			...
			public void clicked(InputEvent event, float x, float y) {
				...
				if(node_hotBar != null) {
					...
					if(slot_hotBar != null && slot_hotBar.itemStack != null && slot_hotBar.itemStack.getItem() != null) {
	...
	public void update(SpriteBatch batch) {
		...
		if(current_item != null && current_item.getItem() instanceof ItemWeapon && ((ItemWeapon)current_item.getItem()).isReloading()) {
	...
	public static class ItemNode extends Button {
		...
		public ItemNode(int slot_id) {
			this(Game.KOMMOC_UI, slot_id);
		}
		
		public ItemNode(Skin skin, int slot_id) {
			super(skin);
			this.slot_id = slot_id;
			//itemStack = Game.CORE.getSessionInventory().getItemStackInSlot(slot_id);
		}
		...
		public void setItem(ItemStack itemStack) {
			...
			item_image = new Image(itemStack.getItem().getIcon());
		...
		public void act(float delta) {
			...
			if(Game.CORE.getSessionInventory() != null &&
					Game.CORE.getSessionInventory().getItemStackInSlot(slot_id) != itemStack) {
				this.setItem(Game.CORE.getSessionInventory().getItemStackInSlot(slot_id));
			}
		}
	}
}
