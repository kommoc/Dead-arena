...
import net.kommocgame.src.gui.DeadArena.DAGuiPlayMenu;
import net.kommocgame.src.gui.DeadArena.DAGuiSettings;

public class DAGuiMainMenu_2 extends GuiBase implements GuiHandler.PreInit {
	...
	public DAGuiMainMenu_2(Game game) {
		super(game);
		...
		image_background.setColor(1f, 1f, 1f, 1);
	...
	public void update(SpriteBatch batch) {
		...
		if(but_play.isChecked()) {
			...
			getGuiManager().addGui(new DAGuiStartMenu(game));
		}
		...
		if(game.guiManager.guiList.peek() != this) {
