...
public class UITest extends ApplicationAdapter {
	...
	@Override
	public void create () {
		skin = new Skin(Gdx.files.internal(Gdx.files.getLocalStoragePath() + "data/neutralizer-ui.json"));
		texture1 = new Texture(Gdx.files.internal(Gdx.files.getLocalStoragePath() + "data/badlogicsmall.png"));
		texture2 = new Texture(Gdx.files.internal("data/badlogic.png"));
		...
		SplitPane splitPane = new SplitPane(scrollPane, rightSideTable, false, skin);
		...
		tooltipTable.pad(10).background("panel");
