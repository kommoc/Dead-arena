...
public class Loader {
	...
	static {
		...
		if(Gdx.app.getType() == ApplicationType.Android) {
			...
			loadAssetsAndroid("android/assets/texture/");
			Path.game_dir = "";
		} else if(Gdx.app.getType() == ApplicationType.Desktop) {
			System.out.print("(DESKTOP) loading.");
			loadAssets(Gdx.files.getLocalStoragePath() + "android/assets/texture/");
	...
	private static void loadFonts() {
		...
		Game.assetManager.load("android/assets/font/console_32.fnt", BitmapFont.class);
		Game.assetManager.load("android/assets/font/console_48.fnt", BitmapFont.class);
		Game.assetManager.load("android/assets/font/console_72.fnt", BitmapFont.class);
		Game.assetManager.load("android/assets/font/console_120.fnt", BitmapFont.class);
		Game.assetManager.load("android/assets/font/console_155.fnt", BitmapFont.class);
	...
	private static void loadSounds() {
		...
		FileHandle path = getGameFile("android/assets/sound/");
		...
		for(FileHandle file : path.list()) {
			...
			if(file.file().getName().endsWith(".ogg")) {
				...
				Game.assetManager.load(file.path().substring(file.path().indexOf("android")), Sound.class);
			}
		}
	...
	private static void loadSkins() {
		...
		Game.assetManager.load("android/assets/skin/NeonUI/neonui/neon-ui.json", Skin.class);
		Game.assetManager.load("android/assets/skin/Neutralizer_UI/neutralizerui/neutralizer-ui.json", Skin.class);
		Game.assetManager.load("android/assets/skin/Kommoc_UI/Kommoc_UI.json", Skin.class);
	...
	private static void loadAtlases() {
		...
		Game.assetManager.load("android/assets/fx/atlas/tex_fx.atlas", TextureAtlas.class);
	...
	private static void loadAssets(String path) {
		...
		if(file.isDirectory()) {
			...
			Game.assetManager.load(file.getPath().substring(file.getPath().indexOf("android")), Texture.class);
		} else {
	...
	public static Texture objects(String path) {
		return Game.assetManager.get("android/assets/texture/objects/" + path, Texture.class);
	}
	
	public static Texture objectsMobs(String name) {
		return Game.assetManager.get("android/assets/texture/objects/mobs/" + name, Texture.class);
	}
	
	public static Texture objectsProps(String name) {
		return Game.assetManager.get("android/assets/texture/objects/props/" + name, Texture.class);
	}
	
	public static Texture objectsItems(String name) {
		return Game.assetManager.get("android/assets/texture/objects/items/" + name, Texture.class);
	}
	
	public static Texture objectsUnits(String name) {
		return Game.assetManager.get("android/assets/texture/objects/units/" + name, Texture.class);
	}
	
	public static Texture objectsWeapons(String name) {
		return Game.assetManager.get("android/assets/texture/objects/weapons/" + name, Texture.class);
	}
	
	public static Texture guiEditor(String path) {
		return Game.assetManager.get("android/assets/texture/gui/editor/" + path, Texture.class);
	}
	
	public static Texture guiMisc(String name) {
		return Game.assetManager.get("android/assets/texture/gui/misc/" + name, Texture.class);
	}
	
	public static Texture guiMiscIcons(String name) {
		return Game.assetManager.get("android/assets/texture/gui/misc/icons/" + name, Texture.class);
	}
	
	public static Texture guiMenuBut(String name) {
		return Game.assetManager.get("android/assets/texture/gui/menu/but/" + name, Texture.class);
	}
	
	public static Texture guiMenuPanel(String name) {
		return Game.assetManager.get("android/assets/texture/gui/menu/panel/" + name, Texture.class);
	}
	
	public static Texture guiMenuSlot(String name) {
		return Game.assetManager.get("android/assets/texture/gui/menu/slot/" + name, Texture.class);
	}
	
	public static Texture guiMenuCONCEPT(String name) {
		return Game.assetManager.get("android/assets/texture/gui/menu/CONCEPT/" + name, Texture.class);
	}
	
	public static Texture guiIcon(String name) {
		return Game.assetManager.get("android/assets/texture/gui/icon/" + name, Texture.class);
	}
	
	public static Texture guiMenuCilia(String name) {
		return Game.assetManager.get("android/assets/texture/gui/menu/cilia/" + name, Texture.class);
	}
	
	public static Texture guiMenuBackground(String name) {
		return Game.assetManager.get("android/assets/texture/gui/menu/background/" + name, Texture.class);
	}
	
	public static Texture impact(String name) {
		return Game.assetManager.get("android/assets/texture/objects/impacts/" + name, Texture.class);
	}
	
	public static Texture level(String path) {
		return Game.assetManager.get("android/assets/texture/levels/" + path, Texture.class);
	}
	...
	public static FileHandle getLevel(String level) {
		return getGameFile("android/assets/SJF/" + level);
	}
	
	/** Return the font-file. Enter only name, suffix will be added automatic.*/
	public static FileHandle getFontFile(String name) {
		return getGameFile("android/assets/fontType/" + name + ".ttf").exists() ? getGameFile("android/assets/fontType/" + name) :
			getGameFile("android/assets/fontType/" + name + ".otf");
	}
	
	/** Return the lang-file. Enter only language, suffix will be added automatic.*/
	public static FileHandle getLangFile(String lang) {
		return getGameFile("android/assets/language/" + lang + "lang-" + lang + ".txt");
	}
