...
public class DAProfile {
	...
	public void loadInventoryPlayer() {
		...
		try {
			if(Loader.getGameFile("assets/player.json").exists() && !newProfile) {
				
				DataInput input_level = new DataInput(Loader.getGameFile("assets/player.json").read());
	...
	public void updatePlayerInventory() {
		...
		try {
			...
			FileWriter out = new FileWriter(Loader.getGameFile("assets/player.json").file());
			out.flush();
			out.write(json_info);
			out.close();
