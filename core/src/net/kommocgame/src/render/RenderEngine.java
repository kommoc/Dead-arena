...
public class RenderEngine {
	...
	public void loadGameAssets() {
		FileHandle fileHandle = net.kommocgame.src.Loader.getGameFile("assets/SCML/sprite_file.scml");
		...
		FileHandle imagesDir = net.kommocgame.src.Loader.getGameFile("assets/fx/texfx/");
		
		EntityFX.fx_explosion_1.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_explosion_1.json"), imagesDir);
		EntityFX.fx_smoke_1.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_smoke_1.json"), imagesDir);
		//EntityFX.fx_shoot_1.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_shoot_1.json"), imagesDir);
		EntityFX.fx_shoot_bloom.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_shoot_bloom.json"), imagesDir);
		EntityFX.fx_shoot_smoke.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_shoot_smoke.json"), imagesDir);
		EntityFX.fx_bullet_1_16.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_bullet_1_16.json"), imagesDir);
		EntityFX.fx_bullet_2_16.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_bullet_2_16.json"), imagesDir);
		EntityFX.fx_bullet_1.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_bullet_1.json"), imagesDir);
		EntityFX.fx_blood_red_1.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_blood_red_1.json"), imagesDir);
		EntityFX.fx_blood_red_2.load(net.kommocgame.src.Loader.getGameFile("assets/fx/FX_blood_red_2.json"), imagesDir);
