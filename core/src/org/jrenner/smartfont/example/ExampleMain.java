...
public class ExampleMain extends ApplicationAdapter {
	...
	public void create() {
		...
		FileHandle exoFile = Gdx.files.getFileHandle(Gdx.files.getLocalStoragePath() + "android/assets/fontType/LiberationMono-Regular.ttf", FileType.Internal);
		
		BitmapFont fontSmall = fontGen.createFont(exoFile, "exo-small", 5);
